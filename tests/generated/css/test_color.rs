...
#[test]
fn test_color_adjuster_css_format_1_59dd4df9() -> Result<()> {
...
#[test]
fn test_color_level_4_css_format_1_75a67dc1() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("css")
        .print_width(80)
        .build()
...
#[test]
fn test_current_color_css_format_1_53db9028() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("css")
        .print_width(80)
        .build()
...
#[test]
fn test_functional_syntax_css_format_1_937c4804() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("css")
        .print_width(80)
        .build()
...
#[test]
fn test_hexcolor_css_format_1_aedb2458() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("css")
        .print_width(80)
        .build()
...
#[test]
fn test_whitespace_syntax_css_format_1_1ede3259() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("css")
        .print_width(80)
        .build()

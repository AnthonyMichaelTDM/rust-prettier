...
#[test]
fn test_builtin_js_format_1_e6ab584e() -> Result<()> {
...
#[test]
fn test_class_js_format_1_abe9d9f4() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_obj_js_format_1_94096ecb() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_optional_js_format_1_45780b70() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

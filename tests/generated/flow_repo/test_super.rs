...
#[test]
fn test_constructor_js_format_1_99f51e53() -> Result<()> {
...
#[test]
fn test_import_js_format_1_d7dcb41c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_super_js_format_1_289bf2ef() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_test_js_format_1_aaee8ef3() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

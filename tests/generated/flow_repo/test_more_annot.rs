...
#[test]
fn test_client_object_js_format_1_9c516d5e() -> Result<()> {
...
#[test]
fn test_object_js_format_1_40670ea4() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_proto_js_format_1_1b2b9452() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_super_js_format_1_3ece38d1() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

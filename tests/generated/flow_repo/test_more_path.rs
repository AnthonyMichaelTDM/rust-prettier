...
#[test]
fn test_condition_js_format_1_6e274b50() -> Result<()> {
...
#[test]
fn test_flow_sa_js_format_1_3dddf903() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_sigma_js_format_1_22494cf5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_test_js_format_1_6989d70e() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

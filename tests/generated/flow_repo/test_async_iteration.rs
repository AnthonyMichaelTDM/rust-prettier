...
#[test]
fn test_delegate_yield_js_format_1_c2e08408() -> Result<()> {
...
#[test]
fn test_generator_js_format_1_32500f2a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_return_js_format_1_c3e908e7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_throw_js_format_1_05d81d64() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

...
#[test]
fn test_class_js_format_1_28fbf59b() -> Result<()> {
...
#[test]
fn test_example_js_format_1_e24d6c0b() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_imports_js_format_1_e1dadfcf() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_library_js_format_1_4354a1f7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

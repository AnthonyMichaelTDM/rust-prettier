...
#[test]
fn test_comments_in_type_annotations_js_babel_flow_format_1_d41d8cd9() {
...
#[test]
fn test_comments_in_type_annotations_js_format_1_6fb41a20() {
    let pretty_printer = PrettyPrinterBuilder::default().build().unwrap();
...
#[test]
fn test_passing_js_babel_flow_format_1_d41d8cd9() {
    let pretty_printer = PrettyPrinterBuilder::default().build().unwrap();
    let formatted = pretty_printer.format("");
    assert!(formatted.is_ok());
    let formatted = formatted.unwrap();
...
#[test]
fn test_passing_js_format_1_3cc21390() {
    let pretty_printer = PrettyPrinterBuilder::default().build().unwrap();

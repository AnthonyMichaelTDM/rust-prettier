...
#[test]
fn test_compatibility_js_format_1_91a46407() -> Result<()> {
...
#[test]
fn test_conversion_js_format_1_c66de3ea() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_objects_js_format_1_92f360d5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_unaliased_assign_js_format_1_d9f78bcd() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

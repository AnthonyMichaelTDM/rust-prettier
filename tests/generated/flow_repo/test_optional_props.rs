...
#[test]
fn test_test_js_format_1_f4ddb081() -> Result<()> {
...
#[test]
fn test_test_2_js_format_1_a76541d0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_test_3_js_format_1_98e7ee2f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_test_3_exact_annot_js_format_1_e143c9c4() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_test_3_failure_js_format_1_09266ae1() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

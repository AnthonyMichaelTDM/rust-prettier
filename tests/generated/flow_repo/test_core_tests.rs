...
#[test]
fn test_boolean_js_format_1_e03a9c6f() -> Result<()> {
...
#[test]
fn test_map_js_format_1_51c6fac4() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_regexp_js_format_1_646b48d9() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_weakset_js_format_1_3e2d7f82() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

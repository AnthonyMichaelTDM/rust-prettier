...
#[test]
fn test_sanity_js_format_1_5cf6d528() -> Result<()> {
...
#[test]
fn test_sanity_multi_params_js_format_1_c806ac42() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_sanity_ordering_js_format_1_c1b6556f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_sanity_unbound_var_js_format_1_456027b5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_simple_predicate_func_js_format_1_0315b95d() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_simple_predicate_func_post_js_format_1_bebbeb6b() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

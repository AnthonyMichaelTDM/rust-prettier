...
#[test]
fn test_api_react_js_format_1_a061eb99() -> Result<()> {
...
#[test]
fn test_app_react_js_format_1_8907865e() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("react.js")
        .print_width(80)
        .build()
...
#[test]
fn test_initialized_fields_js_format_1_725d3e33() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_jsx_js_format_1_9cd2d6b8() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_check_prop_types_js_format_1_ffc87535() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_prop_types_js_format_1_35255060() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

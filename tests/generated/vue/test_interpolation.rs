...
#[test]
fn test_bitwise_or_operator_vue_format_1_248278a7() -> Result<()> {
...
#[test]
fn test_parenthesized_vue_format_1_c9fc6a16() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
        .build()
...
#[test]
fn test_template_vue_format_1_427e4f67() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
        .build()

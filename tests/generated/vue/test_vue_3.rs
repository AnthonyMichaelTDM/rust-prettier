...
#[test]
fn test_script_generic_vue_format_1_04a15e2c() -> Result<()> {
...
#[test]
fn test_script_setup_vue_format_1_a0ef69e0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
        .build()
...
#[test]
fn test_style_variables_vue_format_1_4617b51c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
        .build()

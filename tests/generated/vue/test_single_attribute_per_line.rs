...
#[test]
fn test_sfc_blocks_vue_single_attribute_per_linetrue_format_1_55e70240() -> Result<()> {
...
#[test]
fn test_sfc_blocks_vue_format_1_55e70240() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
        .build()
...
#[test]
fn test_single_attribute_per_line_vue_single_attribute_per_linetrue_format_1_22b10caf() -> Result<()>
{
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
...
#[test]
fn test_single_attribute_per_line_vue_format_1_22b10caf() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
        .build()

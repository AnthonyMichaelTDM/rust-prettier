...
#[test]
fn test_attribute_expr_vue_format_1_c444b4e2() -> Result<()> {
...
#[test]
fn test_basic_vue_format_1_5e122296() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
        .build()
...
#[test]
fn test_comment_vue_format_1_b5d45a9e() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
        .build()
...
#[test]
fn test_filter_vue_format_1_856c9210() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
        .build()
...
#[test]
fn test_not_working_with_non_ts_script_vue_format_1_a2121d7d() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("vue")
        .print_width(80)
        .build()

...
#[test]
fn test_basics_hbs_single_quotetrue_format_1_20a2b98f() -> Result<()> {
...
#[test]
fn test_basics_hbs_format_1_20a2b98f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .build()
...
#[test]
fn test_element_modifier_statement_hbs_single_quotetrue_format_1_759a3292() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .single_quote(true)
...
#[test]
fn test_element_modifier_statement_hbs_format_1_759a3292() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .build()
...
#[test]
fn test_escaped_hbs_single_quotetrue_format_1_43a33fe0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .single_quote(true)
...
#[test]
fn test_escaped_hbs_format_1_43a33fe0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .build()
...
#[test]
fn test_issue_8691_hbs_single_quotetrue_format_1_6d46caaf() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .single_quote(true)
...
#[test]
fn test_issue_8691_hbs_format_1_6d46caaf() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .build()

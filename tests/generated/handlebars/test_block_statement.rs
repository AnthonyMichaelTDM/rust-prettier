...
#[test]
fn test_block_statement_hbs_format_1_42eb9699() -> Result<()> {
...
#[test]
fn test_custom_else_hbs_format_1_48938cc3() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .build()
...
#[test]
fn test_each_hbs_format_1_51caac3b() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .build()
...
#[test]
fn test_if_else_hbs_format_1_8c8a30a0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .build()
...
#[test]
fn test_loop_hbs_format_1_d490d6b1() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .build()

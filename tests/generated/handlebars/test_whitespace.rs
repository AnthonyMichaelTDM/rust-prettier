...
#[test]
fn test_basics_hbs_print_width_40_format_1_218a6559() -> Result<()> {
...
#[test]
fn test_boss_hbs_print_width_40_format_1_ca18ca6e() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_curly_hbs_print_width_40_format_1_9cec655c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_display_inline_block_hbs_print_width_40_format_1_69dd8a70() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_display_none_hbs_print_width_40_format_1_30ef9dce() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_fill_hbs_print_width_40_format_1_a51f7b7e() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_inline_element_hbs_print_width_40_format_1_67ab3d79() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_non_breaking_whitespace_hbs_print_width_40_format_1_36686950() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_preserved_spaces_and_breaks_hbs_print_width_40_format_1_5a5436e7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_punctuation_hbs_print_width_40_format_1_27ce49f7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_surrounding_linebreak_hbs_print_width_40_format_1_2c745e6f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_table_hbs_print_width_40_format_1_2b5f20f4() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_textarea_hbs_print_width_40_format_1_01024a9e() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()
...
#[test]
fn test_whitespace_control_hbs_print_width_40_format_1_39af7daa() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(40)
        .build()

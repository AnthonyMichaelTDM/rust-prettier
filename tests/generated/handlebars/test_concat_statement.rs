...
#[test]
fn test_concat_statement_hbs_single_quotetrue_format_1_6436a1ac() -> Result<()> {
...
#[test]
fn test_concat_statement_hbs_format_1_6436a1ac() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .build()
...
#[test]
fn test_in_attr_node_hbs_single_quotetrue_format_1_7e7dd9a5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .single_quote(true)
...
#[test]
fn test_in_attr_node_hbs_format_1_7e7dd9a5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("hbs")
        .print_width(80)
        .build()

...
#[test]
fn test_single_attribute_per_line_js_single_attribute_per_linetrue_format_1_06ec9d35() -> Result<()>
{
...
#[test]
fn test_single_attribute_per_line_js_format_1_06ec9d35() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

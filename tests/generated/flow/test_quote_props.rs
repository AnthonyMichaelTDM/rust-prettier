...
#[test]
fn test_objects_js_quote_propsas_needed_format_1_b0145bb0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("as-needed")
...
#[test]
fn test_objects_js_quote_propsconsistent_format_1_b0145bb0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("consistent")
...
#[test]
fn test_objects_js_quote_propspreserve_format_1_b0145bb0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("preserve")

...
#[test]
fn test_single_js_arrow_parensavoid_format_1_3c8889a7() -> Result<()> {
...
#[test]
fn test_single_js_trailing_commaall_format_1_3c8889a7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("all")
...
#[test]
fn test_single_js_trailing_commaes_5_format_1_3c8889a7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_test_js_arrow_parensavoid_format_1_4b85d60a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .arrow_parens("avoid")
        .parser("js")
        .print_width(80)
...
#[test]
fn test_test_js_trailing_commaall_format_1_4b85d60a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("all")
...
#[test]
fn test_test_js_trailing_commaes_5_format_1_4b85d60a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("es5")

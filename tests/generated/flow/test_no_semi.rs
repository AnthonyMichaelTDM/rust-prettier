...
#[test]
fn test_comments_js_semifalse_format_1_4e9b38cf() -> Result<()> {
...
#[test]
fn test_comments_js_format_1_4e9b38cf() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_flow_class_properties_js_semifalse_format_1_fab6bf1c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .semi(false)
...
#[test]
fn test_flow_class_properties_js_format_1_fab6bf1c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_flow_interfaces_js_semifalse_format_1_032b36ea() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .semi(false)
...
#[test]
fn test_flow_interfaces_js_format_1_032b36ea() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_no_semi_js_semifalse_format_1_9df4c8de() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .semi(false)
...
#[test]
fn test_no_semi_js_format_1_9df4c8de() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

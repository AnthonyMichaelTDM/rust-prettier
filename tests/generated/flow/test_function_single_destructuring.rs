...
#[test]
fn test_array_js_format_1_24eef00f() -> Result<()> {
...
#[test]
fn test_object_js_format_1_09662034() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_object_type_in_declare_function_js_format_1_59daf8de() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

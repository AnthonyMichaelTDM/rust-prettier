...
#[test]
fn test_attributes_html_semifalse_format_1_d45402bb() -> Result<()> {
...
#[test]
fn test_attributes_html_trailing_commaes_5_format_1_d45402bb() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_attributes_html_trailing_commanone_format_1_d45402bb() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .trailing_comma("none")

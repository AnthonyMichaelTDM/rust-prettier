...
#[test]
fn test_classes_js_quote_propsas_needed_format_1_3ff08b74() -> Result<()> {
...
#[test]
fn test_classes_js_quote_propsconsistent_format_1_3ff08b74() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
...
#[test]
fn test_classes_js_quote_propspreserve_format_1_3ff08b74() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
...
#[test]
fn test_numeric_separator_js_quote_propsas_needed_format_1_d507fef6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("as-needed")
...
#[test]
fn test_numeric_separator_js_quote_propsconsistent_format_1_d507fef6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("consistent")
...
#[test]
fn test_numeric_separator_js_quote_propspreserve_format_1_d507fef6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("preserve")
...
#[test]
fn test_objects_js_quote_propsas_needed_format_1_a94f4565() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("as-needed")
...
#[test]
fn test_objects_js_quote_propsconsistent_format_1_a94f4565() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("consistent")
...
#[test]
fn test_objects_js_quote_propspreserve_format_1_a94f4565() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("preserve")
...
#[test]
fn test_with_member_expressions_js_quote_propsas_needed_format_1_ae25f94c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("as-needed")
...
#[test]
fn test_with_member_expressions_js_quote_propsconsistent_format_1_ae25f94c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("consistent")
...
#[test]
fn test_with_member_expressions_js_quote_propspreserve_format_1_ae25f94c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("preserve")
...
#[test]
fn test_with_numbers_js_quote_propsas_needed_format_1_e2fe5220() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("as-needed")
...
#[test]
fn test_with_numbers_js_quote_propsconsistent_format_1_e2fe5220() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("consistent")
...
#[test]
fn test_with_numbers_js_quote_propspreserve_format_1_e2fe5220() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .quote_props("preserve")

...
#[test]
fn test_functions_js_single_quotetrue_format_1_6ca951c6() -> Result<()> {
...
#[test]
fn test_functions_js_format_1_6ca951c6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_objects_js_single_quotetrue_format_1_e33fe9ff() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .single_quote(true)
...
#[test]
fn test_objects_js_format_1_e33fe9ff() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_strings_js_single_quotetrue_format_1_74b5ff1f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .single_quote(true)
...
#[test]
fn test_strings_js_format_1_74b5ff1f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

...
#[test]
fn test_comment_before_else_js_format_1_4fe5ed44() -> Result<()> {
...
#[test]
fn test_else_js_format_1_b6121974() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_expr_and_same_line_comments_js_format_1_5eb9ac88() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_if_comments_js_format_1_108029f9() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_trailing_comment_js_format_1_4ba2c1a2() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

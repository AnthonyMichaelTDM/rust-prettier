...
#[test]
fn test_arrow_call_js_arrow_parensalways_format_1_c84100cf() -> Result<()> {
...
#[test]
fn test_arrow_call_js_trailing_commaall_format_1_c84100cf() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("all")
...
#[test]
fn test_arrow_call_js_trailing_commaes_5_format_1_c84100cf() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_class_property_js_arrow_parensalways_format_1_af0c3ec6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .arrow_parens("always")
        .parser("js")
        .print_width(80)
...
#[test]
fn test_class_property_js_trailing_commaall_format_1_af0c3ec6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("all")
...
#[test]
fn test_class_property_js_trailing_commaes_5_format_1_af0c3ec6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("es5")

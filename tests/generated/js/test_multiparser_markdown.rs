...
#[test]
fn test_0_indent_js_prose_wrapalways_format_1_8aab4309() -> Result<()> {
...
#[test]
fn test_codeblock_js_prose_wrapalways_format_1_7207cd2f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .prose_wrap("always")
...
#[test]
fn test_escape_js_prose_wrapalways_format_1_1822a523() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .prose_wrap("always")
...
#[test]
fn test_issue_5021_js_prose_wrapalways_format_1_80bd1de9() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .prose_wrap("always")
...
#[test]
fn test_markdown_js_prose_wrapalways_format_1_c81db771() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .prose_wrap("always")
...
#[test]
fn test_single_line_js_prose_wrapalways_format_1_0a8b2df4() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .prose_wrap("always")

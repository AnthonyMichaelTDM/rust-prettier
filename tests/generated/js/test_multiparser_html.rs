...
#[test]
fn test_html_template_literals_js_html_whitespace_sensitivityignore_format_1_90ff0b43() -> Result<()>
{
...
#[test]
fn test_html_template_literals_js_format_1_90ff0b43() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_issue_10691_js_html_whitespace_sensitivityignore_format_1_0819a514() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .html_whitespace_sensitivity("ignore")
        .parser("js")
        .print_width(80)
...
#[test]
fn test_issue_10691_js_format_1_0819a514() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_lit_html_js_html_whitespace_sensitivityignore_format_1_53f6cb4f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .html_whitespace_sensitivity("ignore")
        .parser("js")
        .print_width(80)
...
#[test]
fn test_lit_html_js_format_1_53f6cb4f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

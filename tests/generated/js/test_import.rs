...
#[test]
fn test_brackets_js_bracket_spacingfalse_format_1_47430aa8() -> Result<()> {
...
#[test]
fn test_brackets_js_format_1_47430aa8() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_comments_js_bracket_spacingfalse_format_1_a55289af() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_spacing(false)
        .parser("js")
        .print_width(80)
...
#[test]
fn test_comments_js_format_1_a55289af() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_empty_import_js_bracket_spacingfalse_format_1_88610474() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_spacing(false)
        .parser("js")
        .print_width(80)
...
#[test]
fn test_empty_import_js_format_1_88610474() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_inline_js_bracket_spacingfalse_format_1_e33f2b77() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_spacing(false)
        .parser("js")
        .print_width(80)
...
#[test]
fn test_inline_js_format_1_e33f2b77() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_long_line_js_bracket_spacingfalse_format_1_041136ae() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_spacing(false)
        .parser("js")
        .print_width(80)
...
#[test]
fn test_long_line_js_format_1_041136ae() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_multiple_standalones_js_bracket_spacingfalse_format_1_9ccab025() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_spacing(false)
        .parser("js")
        .print_width(80)
...
#[test]
fn test_multiple_standalones_js_format_1_9ccab025() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_same_local_and_imported_js_bracket_spacingfalse_format_1_1c047fdd() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_spacing(false)
        .parser("js")
        .print_width(80)
...
#[test]
fn test_same_local_and_imported_js_format_1_1c047fdd() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

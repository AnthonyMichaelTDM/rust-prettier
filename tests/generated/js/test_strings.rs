...
#[test]
fn test_escaped_js_trailing_commaall_format_1_7da35aab() -> Result<()> {
...
#[test]
fn test_escaped_js_trailing_commaes_5_format_1_7da35aab() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_multiline_literal_js_trailing_commaall_format_1_74bb47c4() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("all")
...
#[test]
fn test_multiline_literal_js_trailing_commaes_5_format_1_74bb47c4() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_non_octal_eight_and_nine_js_trailing_commaall_acorn_format_1_d41d8cd9() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .build()
        .unwrap();
...
#[test]
fn test_non_octal_eight_and_nine_js_trailing_commaall_espree_format_1_d41d8cd9() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .build()
        .unwrap();
...
#[test]
fn test_non_octal_eight_and_nine_js_trailing_commaall_format_1_959bf89a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("all")
...
#[test]
fn test_non_octal_eight_and_nine_js_trailing_commaes_5_acorn_format_1_d41d8cd9() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .build()
        .unwrap();
...
#[test]
fn test_non_octal_eight_and_nine_js_trailing_commaes_5_espree_format_1_d41d8cd9() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .build()
        .unwrap();
...
#[test]
fn test_non_octal_eight_and_nine_js_trailing_commaes_5_format_1_959bf89a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_strings_js_trailing_commaall_format_1_fa3beb71() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("all")
...
#[test]
fn test_strings_js_trailing_commaes_5_format_1_fa3beb71() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_template_literals_js_trailing_commaall_format_1_f3f169a1() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("all")
...
#[test]
fn test_template_literals_js_trailing_commaes_5_format_1_f3f169a1() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .trailing_comma("es5")

...
#[test]
fn test_break_js_format_1_a77fb8c0() -> Result<()> {
...
#[test]
fn test_parent_js_format_1_3fab6729() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_react_js_format_1_29ab3dbe() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()
...
#[test]
fn test_reduce_js_format_1_f46932d1() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("js")
        .print_width(80)
        .build()

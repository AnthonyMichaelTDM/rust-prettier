...
#[test]
fn test_9734_md_trailing_commaall_format_1_ebdc8df0() -> Result<()> {
...
#[test]
fn test_jsx_comment_md_trailing_commaall_format_1_b309925f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("md")
        .print_width(80)
        .trailing_comma("all")
...
#[test]
fn test_meta_in_code_block_md_trailing_commaall_format_1_a13a5346() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("md")
        .print_width(80)
        .trailing_comma("all")
...
#[test]
fn test_trailing_comma_md_trailing_commaall_format_1_e188516a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("md")
        .print_width(80)
        .trailing_comma("all")

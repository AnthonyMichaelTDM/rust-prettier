...
#[test]
fn test_chinese_japanese_md_prose_wrapalways_format_1_f88d35ce() -> Result<()> {
...
#[test]
fn test_han_kana_alnum_md_prose_wrapalways_format_1_92a11556() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("md")
        .print_width(80)
        .prose_wrap("always")
...
#[test]
fn test_korean_md_prose_wrapalways_format_1_763c15b1() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("md")
        .print_width(80)
        .prose_wrap("always")
...
#[test]
fn test_link_md_prose_wrapalways_format_1_44e7f1dd() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("md")
        .print_width(80)
        .prose_wrap("always")
...
#[test]
fn test_mixed_md_prose_wrapalways_format_1_5264ed27() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("md")
        .print_width(80)
        .prose_wrap("always")
...
#[test]
fn test_space_md_prose_wrapalways_format_1_b140f499() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("md")
        .print_width(80)
        .prose_wrap("always")
...
#[test]
fn test_symbol_space_new_line_md_prose_wrapalways_format_1_854839b0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("md")
        .print_width(80)
        .prose_wrap("always")

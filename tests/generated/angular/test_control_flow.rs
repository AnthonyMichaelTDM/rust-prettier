...
#[test]
fn test_after_close_tag_html_format_1_5d6c7ee1() -> Result<()> {
...
#[test]
fn test_chid_html_format_1_7485573e() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_defer_html_format_1_41bedaba() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_element_tags_html_format_1_5abe714a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_for_html_format_1_9bc1cdc8() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_if_html_format_1_0c8bf85f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_mix_html_format_1_8ba93dc5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_switch_html_format_1_bda03d4f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_unclosed_html_format_1_fb198443() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_unknown_block_html_format_1_b3bdde1a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_with_comment_html_format_1_39506734() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()

...
#[test]
fn test_interface_graphql_format_1_f0ebdc18() -> Result<()> {
...
#[test]
fn test_object_type_def_graphql_format_1_bd3090a2() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()
...
#[test]
fn test_object_type_def_mixed_syntax_graphql_format_1_118b8080() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()
...
#[test]
fn test_object_type_def_old_syntax_graphql_format_1_32d6bbb7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()
...
#[test]
fn test_separator_detection_graphql_format_1_e16c5aac() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()

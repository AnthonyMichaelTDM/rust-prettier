...
#[test]
fn test_directive_decl_graphql_format_1_73bf5a9b() -> Result<()> {
...
#[test]
fn test_directives_graphql_format_1_790f3011() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()
...
#[test]
fn test_enum_graphql_format_1_126f3173() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()
...
#[test]
fn test_fields_graphql_format_1_8e66c31d() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()
...
#[test]
fn test_input_graphql_format_1_f4861a8e() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()
...
#[test]
fn test_interface_graphql_format_1_2bfd3eb7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()
...
#[test]
fn test_object_type_def_graphql_format_1_9b3925fe() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()
...
#[test]
fn test_schema_graphql_format_1_3d9f3c6b() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("graphql")
        .print_width(80)
        .build()

...
#[test]
fn test_comments_ts_format_1_9906b5bd() -> Result<()> {
...
#[test]
fn test_inlining_ts_format_1_497b703f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_union_parens_ts_format_1_39a0459c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_with_type_params_ts_format_1_d166ebb6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()

...
#[test]
fn test_issue_14238_ts_format_1_95cbe190() -> Result<()> {
...
#[test]
fn test_mapped_types_ts_format_1_368d2341() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_prettier_ignore_nested_unions_ts_format_1_02cdfadc() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()

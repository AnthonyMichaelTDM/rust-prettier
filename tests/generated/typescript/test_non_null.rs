...
#[test]
fn test_braces_ts_format_1_b92efe7d() -> Result<()> {
...
#[test]
fn test_member_chain_ts_format_1_83719e1f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_optional_chain_ts_format_1_63d8aa6b() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_parens_ts_format_1_93bf15b9() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()

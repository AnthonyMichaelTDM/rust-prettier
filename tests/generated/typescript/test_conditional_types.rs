...
#[test]
fn test_comments_ts_experimental_ternariestrue_format_1_2a62ba1a() -> Result<()> {
...
#[test]
fn test_comments_ts_format_1_2a62ba1a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_conditonal_types_ts_experimental_ternariestrue_format_1_1719f4f7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .experimental_ternaries(true)
        .parser("ts")
        .print_width(80)
...
#[test]
fn test_conditonal_types_ts_format_1_1719f4f7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_infer_type_ts_experimental_ternariestrue_format_1_6bcaccfb() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .experimental_ternaries(true)
        .parser("ts")
        .print_width(80)
...
#[test]
fn test_infer_type_ts_format_1_6bcaccfb() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_nested_in_condition_ts_experimental_ternariestrue_format_1_cae67eb0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .experimental_ternaries(true)
        .parser("ts")
        .print_width(80)
...
#[test]
fn test_nested_in_condition_ts_format_1_cae67eb0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_new_ternary_spec_ts_experimental_ternariestrue_format_1_3fbd66bd() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .experimental_ternaries(true)
        .parser("ts")
        .print_width(80)
...
#[test]
fn test_new_ternary_spec_ts_format_1_3fbd66bd() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_parentheses_ts_experimental_ternariestrue_format_1_de3ed8a0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .experimental_ternaries(true)
        .parser("ts")
        .print_width(80)
...
#[test]
fn test_parentheses_ts_format_1_de3ed8a0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()

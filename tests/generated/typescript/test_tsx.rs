...
#[test]
fn test_generic_component_tsx_format_1_8be6b91f() -> Result<()> {
...
#[test]
fn test_keyword_tsx_format_1_1f24a857() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("tsx")
        .print_width(80)
        .build()
...
#[test]
fn test_member_expression_tsx_format_1_f5df4608() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("tsx")
        .print_width(80)
        .build()
...
#[test]
fn test_not_react_ts_format_1_45f4b7ec() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_react_tsx_format_1_75a18212() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("tsx")
        .print_width(80)
        .build()
...
#[test]
fn test_this_tsx_format_1_9a0444ad() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("tsx")
        .print_width(80)
        .build()
...
#[test]
fn test_type_parameters_tsx_format_1_39feef19() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("tsx")
        .print_width(80)
        .build()
...
#[test]
fn test_url_tsx_format_1_4ac89751() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("tsx")
        .print_width(80)
        .build()

...
#[test]
fn test_arrow_return_type_ts_format_1_fa44743a() -> Result<()> {
...
#[test]
fn test_issue_6899_ts_format_1_cb72c001() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_object_method_ts_format_1_b4a911f9() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_ungrouped_parameters_ts_format_1_a3623372() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()

...
#[test]
fn test_multiline_ts_end_of_linecr_format_1_6f3fdc10() -> Result<()> {
...
#[test]
fn test_multiline_ts_end_of_linecrlf_format_1_6f3fdc10() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .end_of_line("crlf")
        .parser("ts")
        .print_width(80)
...
#[test]
fn test_multiline_ts_end_of_linelf_format_1_6f3fdc10() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .end_of_line("lf")
        .parser("ts")
        .print_width(80)

...
#[test]
fn test_dangling_ts_semifalse_format_1_7f70bc26() -> Result<()> {
...
#[test]
fn test_dangling_ts_format_1_7f70bc26() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_issues_ts_semifalse_format_1_23eed1a5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .semi(false)
...
#[test]
fn test_issues_ts_format_1_23eed1a5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_last_arg_ts_semifalse_format_1_07d2f8bc() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .semi(false)
...
#[test]
fn test_last_arg_ts_format_1_07d2f8bc() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()

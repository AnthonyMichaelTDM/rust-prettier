...
#[test]
fn test_class_implements_ts_format_1_f019f137() -> Result<()> {
...
#[test]
fn test_declare_ts_format_1_58a58e5b() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_generic_ts_format_1_c630a59d() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_misc_ts_format_1_43265726() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()

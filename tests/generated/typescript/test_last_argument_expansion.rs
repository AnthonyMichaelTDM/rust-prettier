...
#[test]
fn test_break_ts_format_1_b2105a4c() -> Result<()> {
...
#[test]
fn test_decorated_function_tsx_format_1_fa933373() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("tsx")
        .print_width(80)
        .build()
...
#[test]
fn test_edge_case_ts_format_1_438e2ab7() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_forward_ref_tsx_format_1_5a445a7f() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("tsx")
        .print_width(80)
        .build()

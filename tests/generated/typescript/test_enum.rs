...
#[test]
fn test_computed_members_ts_babel_ts_format_1_d41d8cd9() -> Result<()> {
...
#[test]
fn test_computed_members_ts_format_1_7612997c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_enum_ts_format_1_329aea72() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()
...
#[test]
fn test_multiline_ts_format_1_8c6383dc() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("ts")
        .print_width(80)
        .build()

...
#[test]
fn test_empty_html_format_1_035236f6() -> Result<()> {
...
#[test]
fn test_js_html_format_1_176c0134() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_simple_html_format_1_972833c9() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_single_script_html_format_1_51caaeb4() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_something_else_html_format_1_e47fe3f1() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_template_literal_html_format_1_e80685dd() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_typescript_html_format_1_65fa3d79() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()

...
#[test]
fn test_block_html_bracket_same_linefalse_format_1_548aa6c5() -> Result<()> {
...
#[test]
fn test_block_html_bracket_same_linetrue_format_1_548aa6c5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
...
#[test]
fn test_embed_html_bracket_same_linefalse_format_1_c1da19d6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_same_line(false)
        .parser("html")
        .print_width(80)
...
#[test]
fn test_embed_html_bracket_same_linetrue_format_1_c1da19d6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_same_line(true)
        .parser("html")
        .print_width(80)
...
#[test]
fn test_inline_html_bracket_same_linefalse_format_1_acf1a3d6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_same_line(false)
        .parser("html")
        .print_width(80)
...
#[test]
fn test_inline_html_bracket_same_linetrue_format_1_acf1a3d6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_same_line(true)
        .parser("html")
        .print_width(80)
...
#[test]
fn test_void_elements_html_bracket_same_linefalse_format_1_2fc07cc5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_same_line(false)
        .parser("html")
        .print_width(80)
...
#[test]
fn test_void_elements_html_bracket_same_linetrue_format_1_2fc07cc5() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .bracket_same_line(true)
        .parser("html")
        .print_width(80)

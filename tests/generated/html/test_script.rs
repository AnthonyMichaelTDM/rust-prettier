...
#[test]
fn test_babel_html_format_1_90dae268() -> Result<()> {
...
#[test]
fn test_legacy_html_format_1_aa734793() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_module_html_format_1_7d0a01df() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_module_attributes_html_format_1_b8d97a53() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_script_html_format_1_1a0381ee() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()

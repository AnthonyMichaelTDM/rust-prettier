...
#[test]
fn test_attributes_html_format_1_95a3b9f4() -> Result<()> {
...
#[test]
fn test_boolean_html_format_1_41b1294d() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_case_sensitive_html_format_1_8f27dd9b() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_class_bem_1_html_format_1_31f63510() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_class_bem_2_html_format_1_be67a09d() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_class_colon_html_format_1_0885e4f8() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_class_leading_dashes_html_format_1_e7ed1b15() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_class_many_short_names_html_format_1_622552cd() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_class_names_html_format_1_eb416ff6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_class_print_width_edge_html_format_1_c9e3ac68() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_dobule_quotes_html_format_1_354b3c8b() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
        .unwrap();
    let formatted =
        pretty_printer.format("<img src=\"test.png\" alt=\"John 'ShotGun' Nelson\">")?;
    assert_eq!(
        formatted,
...
#[test]
fn test_duplicate_html_format_1_67b111f0() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_single_quotes_html_format_1_598fc7f6() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_smart_quotes_html_format_1_fe3821bd() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_srcset_html_format_1_4c4d6c08() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_style_html_format_1_024bffce() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()
...
#[test]
fn test_without_quotes_html_format_1_a9d3fa07() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("html")
        .print_width(80)
        .build()

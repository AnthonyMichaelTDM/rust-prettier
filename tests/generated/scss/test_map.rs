...
#[test]
fn test_key_values_scss_trailing_commaes_5_format_1_6a7c6abf() -> Result<()> {
...
#[test]
fn test_key_values_scss_trailing_commanone_format_1_6a7c6abf() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("none")
...
#[test]
fn test_keys_scss_trailing_commaes_5_format_1_566e5ada() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_keys_scss_trailing_commanone_format_1_566e5ada() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("none")

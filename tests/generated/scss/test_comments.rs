...
#[test]
fn test_crlf_scss_format_1_85c8b3b5() -> Result<()> {
...
#[test]
fn test_at_rule_scss_format_1_574c4f4b() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_between_decl_scss_format_1_c0c24f69() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_bug_scss_format_1_6093d627() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_custom_properties_scss_format_1_8c1e8782() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_if_eslit_at_rule_decloration_scss_format_1_28304628() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_in_value_scss_format_1_9139fb64() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_lists_scss_format_1_2d21ed44() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_maps_scss_format_1_c043009c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_mixed_scss_format_1_a2bbf8f2() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_mixed_2_scss_format_1_9d388255() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_mixed_block_scss_format_1_eb71963e() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_prettier_ignore_scss_format_1_ef5e979b() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_selectors_scss_format_1_1b4452e4() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_trailing_star_slash_scss_format_1_67c36f8a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_variable_declaration_scss_format_1_8d9748d2() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()

...
#[test]
fn test_apply_rule_scss_format_1_bdad1509() -> Result<()> {
...
#[test]
fn test_postcss_8_improment_scss_format_1_3a47d3ca() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()
...
#[test]
fn test_variables_scss_format_1_dad4aeac() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .build()

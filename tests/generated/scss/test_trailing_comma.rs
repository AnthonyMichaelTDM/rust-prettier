...
#[test]
fn test_at_rules_scss_trailing_commaes_5_format_1_9208d4ff() -> Result<()> {
...
#[test]
fn test_at_rules_scss_trailing_commanone_format_1_9208d4ff() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("none")
...
#[test]
fn test_declaration_scss_trailing_commaes_5_format_1_351a4dcc() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_declaration_scss_trailing_commanone_format_1_351a4dcc() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("none")
...
#[test]
fn test_list_scss_trailing_commaes_5_format_1_d1a3021a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_list_scss_trailing_commanone_format_1_d1a3021a() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("none")
...
#[test]
fn test_map_scss_trailing_commaes_5_format_1_305b355c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_map_scss_trailing_commanone_format_1_305b355c() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("none")
...
#[test]
fn test_selector_list_scss_trailing_commaes_5_format_1_d1e9c00d() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_selector_list_scss_trailing_commanone_format_1_d1e9c00d() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("none")
...
#[test]
fn test_variable_scss_trailing_commaes_5_format_1_257a4bf8() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("es5")
...
#[test]
fn test_variable_scss_trailing_commanone_format_1_257a4bf8() -> Result<()> {
    let pretty_printer = PrettyPrinterBuilder::default()
        .parser("scss")
        .print_width(80)
        .trailing_comma("none")
